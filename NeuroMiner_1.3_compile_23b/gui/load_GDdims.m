...
if isfield(handles.params.TrainParam.SVM,'BBQ') && handles.params.TrainParam.SVM.BBQ.flag
    handles.calibflag = true;
else
...
if isfield(GDdims,'BinClass') || isfield(GDdims,'MultiClass') 
    ...
    for j=1:handles.nclass
        ...
        handles.BinClass{j}.tbl.colnames        = {'Cases', 'EXP_LABEL', 'PRED_LABEL', 'Errors', 'Mean_Score', 'Std_Score', 'Ens_ProbPred', 'PercRank_Score'};
        ...
        handles.BinClass{j}.tbl.array           = [handles.BinClass{j}.labelh ...
                                                   ...
                                                   ranktransform(handles.BinClass{j}.mean_predictions)];
