...
% =                             REGRESSION PLOT                           =
% =========================================================================
function handles = display_regrplot_app(handles, markflag, oocvflag, oocvprepflag, binarizeflag, alphax)
...
figdata.hPanel   = uipanel('Units','norm', 'Position',hText.Extent, 'BackgroundColor', [.6 .7 .6], 'Visible','off');
