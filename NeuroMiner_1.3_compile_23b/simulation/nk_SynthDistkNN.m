...
if strcmp(distanceMeasure,'Mahalanobis')
    ...
    covarianceMatrix = cov(realData, 'omitrows');
    covHat = nearestSPD(covarianceMatrix); % matrix close to covariance matrix that is symmetric and positive definite
end
...
for i = 1:numSyntheticObservations
    ...
    realObservationIndex = randi(size(realData, 1));
    ...
    switch distanceMeasure
        ...
        case 'Mahalanobis'
            ...
            distances = sqrt(pdist2(std_realData, std_realObservation, 'mahalanobis', covHat));
        case 'Wasserstein'
