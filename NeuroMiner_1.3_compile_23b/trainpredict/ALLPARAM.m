...
% =========================================================================
% Compute all model performance parameters
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if numel(unique(expected))>1 
    ...
    n1 = sum(expected == 1);
    n2 = sum(expected == -1);
    q0 = param.AUC*(1-param.AUC);
    q1 = param.AUC/(2-param.AUC)-param.AUC.^2;
    q2 = 2*param.AUC.^2/(1+param.AUC)-param.AUC.^2;
...
param.ECE = ECE( expected, predicted);
