...
ARD (Automatic Relevance Determination): Suffixes like ardsquaredexponential enable a feature where the model can automatically learn the relative importance of different hyperparameters, which is very useful in high-dimensional spaces.
