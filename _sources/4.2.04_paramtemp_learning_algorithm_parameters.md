...
### How to enable
- In *Learning algorithm parameters* → **Specify cross‑parameter model selection process**, choose **Simulated annealing** or **Bayesian optimization**.
- Define a **budget** (max evaluations), optional **early‑stopping**, and **target metric** (AUC/BAC/MSE/…).
...
> NM 1.4 applies SA/BO consistently for **binary**, **regression**, and **multi‑class** setups.

:::{note}
You'll need the Statistics & Machine Learning Toolbox to use Bayesian Optimization. 
:::
