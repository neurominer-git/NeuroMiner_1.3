...
This powerful feature is used to correct for a potential "domain shift" or "batch effect" where the distribution of classifier scores for the OOCV dataset is systematically different from the training dataset. It works by aligning the median of the OOCV scores with the median of the training scores.
