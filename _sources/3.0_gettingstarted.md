...
## Support Matrix (NM 1.4)

**MATLAB**: R2020b+ (R2021b+ recommended for App Designer features).  
**OS**: Windows, Linux, macOS.  
**Python**: MATLAB‑compatible Python linked via *Python integration in MATLAB*.  
**Optional GPU**: TensorFlow GPU build + matching CUDA/cuDNN (if deep models are used).

See also: *Python integration in MATLAB* for environment linking and TensorFlow setup.
