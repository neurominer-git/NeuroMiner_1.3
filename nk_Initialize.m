...
if OCTAVE
    NMinfo.info.ver     = sprintf('Version 1.3 | CURUFIN [OCTAVE %s]', OCTAVE_VERSION);
else
    matver = ver('matlab');
    NMinfo.info.ver     = sprintf('Version 1.3 | CURUFIN [%s %s]', matver.Name, matver.Release);
end
...
NMinfo.info.dep     = 'Dept. of Psychiatry and Psychotherapy / Department of Psychosis Studies';
NMinfo.info.inst    = 'Ludwig-Maximilians-University / King''s College London';
NMinfo.info.datever = '08/2024';
