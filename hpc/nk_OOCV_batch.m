...
oocvind             = str2double(params{1}{5});		% OOCV data index 
...
ovrwrt              = str2double(params{1}{8});      % of re-computing them 
...
permflag            = str2double(params{1}{11});
nperms              = str2double(params{1}{12});
curCPU              = str2double(params{1}{13});		% Current CPU to be used
numCPU              = str2double(params{1}{14});    % Number of CPUs in the submitted job
CV2x1               = str2double(params{1}{15});    % Range param for CV2 grid definition: Perm start CV2
CV2x2               = str2double(params{1}{16});    % Range param for CV2 grid definition: Perm end CV2
CV2y1               = str2double(params{1}{17});    % Range param for CV2 grid definition: Fold start CV2
CV2y2               = str2double(params{1}{18});	% Range param for CV2 grid definition: Fold end CV2
...
inp = struct( 'analind', analind, ...
                ...
                'batchflag', 1, ...
                'saveCV1', 2, ...
                'PERM', struct( 'flag', permflag, 'nperms', nperms), ...
                'HideGridAct',false);
