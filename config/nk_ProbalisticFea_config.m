...
if ~defaultsfl && ~isempty(PFE)
    ...
    switch tPFE.Mode
        ...
        case 2
            PROBFEASTR_MODE = sprintf('%g of most consistently selected features', tPFE.Perc);
        case 3
            PROBFEASTR_MODE = sprintf('%g%% of most consistently selected features', tPFE.Perc);
    end
        ...
        case 2
            if tPFE.flag == 1
                ...
                switch tPFE.Mode
                    ...
                    case 3
                        tPFE.Perc    = nk_input('Define percentage [%] of features to be selected from consistency-based ranking list',0,'i', tPFE.Perc);
                end
