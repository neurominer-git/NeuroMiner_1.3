...
if isfield(SVM,'prog')
    ...
    if isfield(SVM,'prog') && ~any(strcmp(SVM.prog,{'kNNMEX','GLMFIT','DECTRE','RNDFOR','MEXELM','ELASVM','ROBSVM', 'MLPERC'}))
    ...
    % in these cases
    if any(strcmp(SVM.prog,{'IMRELF','kNNMEX','LIBLIN','ROBSVM','GLMFIT','MEXELM', 'DECTRE','RNDFOR', 'GLMNET','GRDBST','SEQOPT','WBLCOX', 'ELASVM', 'MLPERC'}))
        ...
        if EXPERT
           ...
           sftval   = [ 'LIBSVM'; ...
            ...
            sftmenu = ['SVM --------------> LIBSVM|' ...
                       ...
                       'GLMNET -----------> Hastie''s library for LASSO/Elastic-net regularized GLMs|' ...
                       'GRADIENT BOOST----> Python''s sklearn.ensemble.GradientBoostingClassifier algorithm|' ... 
                       'ML PERCEPTRON-----> Python''s sklearn.neural_network.MLPClassifier algorithm|'];
    ...
    case 'regression'
        if EXPERT
            sftmenu = [ 'SVM --------------> LIBSVM|' ...
                        ...
                        'ML PERCEPTRON-----> Python''s sklearn.neural_network.MLPRegressor algorithm|']; %... 
                        %'GRADIENT BOOST----> Python''s sklearn.ensemble.GradientBoostingRegressor algorithm'];
            sftval = ['LIBSVM'; ...
                      'LIBLIN'; ...
                      'MikRVM'; ...
